...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies_hancss: string;
	export const npm_package_devDependencies_eslint_config_prettier: string;
	export const npm_package_dependencies_hns_library: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		TURBO_HASH: string;
		XPC_FLAGS: string;
		npm_package_dependencies_hancss: string;
		npm_package_devDependencies_eslint_config_prettier: string;
		npm_package_dependencies_hns_library: string;
